...
public class _04_03_ListOfDepthsTest {
    ...
    public void withOneElement() {
        List<LinkedList<BinaryTreeNode>> linkedLists = s.create(new BinaryTreeNode(1));
        List<LinkedList<BinaryTreeNode>> results = new ArrayList<>();
        results.add(new LinkedList<BinaryTreeNode>(Collections.singletonList(new BinaryTreeNode(1))));
    ...
    public void withTwoElements() {
        ...
        List<LinkedList<BinaryTreeNode>> linkedLists = s.create(node);
